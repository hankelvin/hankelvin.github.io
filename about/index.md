...
Before that, I did my MSc (Natural Language Processing) at the [_Institut des sciences du Digital, Management & Cognition (IDMC)_](https://idmc.univ-lorraine.fr/) also in the Université de Lorraine. I also hold an [MA (South-east Asian Studies)](https://fass.nus.edu.sg/sea/) from the National University of Singapore where I focused on Indonesian political economy. I did my BSc (Economics) with a minor in Political Science from the [Singapore Management University](https://www.smu.edu.sg/).
